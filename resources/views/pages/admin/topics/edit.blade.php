...
@section('content')
<x-admin.breadcrumb :title="__('Edit Topic')">
        ...
        <div class="col-sm-12">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-dark">
                    <h5 class="mb-0">
                        <i class="icofont icofont-edit"></i> {{ __('Edit Topic') }}
                    </h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input
                                    ...
                                    value="{{ old('translations.'.$language->id.'.name', optional($topic->translations->firstWhere('language_id', $language->id))->name) }}"
